...
export default function Header() {
  ...
  const LOGO_URL = config.site.logo;
  const NOME_LOJA = config.site.name;
      ...
      <header className="mv-header">
        ...
        <div className="header-content">
          ...
          <div className="site-logo-wrapper">
            <img
              src={LOGO_URL || `${import.meta.env.BASE_URL}logo.svg`}
              onError={(event) => { event.currentTarget.onerror = null; event.currentTarget.src = `${import.meta.env.BASE_URL}logo.svg`; }}
              alt={NOME_LOJA}
              className="site-logo"
            />
          </div>
              ...
              >
                <g transform="translate(-201.44063,-235.75466)">
                  <path
                    ...
                    fill="none"
                    stroke="rgb(var(--tone-212-175-55))"
                    strokeWidth="7"
                    strokeLinecap="round"
                ...
                >
                  <defs>
                    ...
                    >
                      <stop
                        offset="0%"
                        stopColor="rgb(var(--tone-246-219-131))"
                      />

                      <stop
                        offset="40%"
                        stopColor="rgb(var(--tone-212-175-55))"
                      />

                      <stop
                        offset="75%"
                        stopColor="rgb(var(--tone-184-134-46))"
                      />

                      <stop
                        offset="100%"
                        stopColor="rgb(var(--tone-121-85-26))"
                      />
                    </linearGradient>
                  </defs>
                  ...
                  <g transform="translate(-164.41679,-112.94712)">
                    ...
                    <path
                      ...
                      fill="rgb(var(--tone-139-100-31))"
                      stroke="rgb(var(--tone-244-214-117))"
                      strokeWidth="4"
                    />
                ...
                >
                  <defs>
                    ...
                    >
                      <stop
                        offset="0%"
                        stopColor="rgb(var(--tone-255-231-155))"
                      />
                      ...
                      <stop
                        offset="100%"
                        stopColor="rgb(var(--tone-154-109-33))"
                      />
                    </linearGradient>
                  </defs>
                  ...
                  <g transform="translate(-191.87889,-75.62023)">
                    ...
                    <path
                      ...
                      fill="none"
                      stroke="rgb(var(--tone-248-220-122))"
                      strokeWidth="6"
                      strokeLinecap="round"
                    />
